  ...
  SDL_Texture **enemy, SDL_Texture **tiles, SDL_Texture **shadow)
  {
    ...
    *enemy = IMG_LoadTexture(renderer, "images/NETFLIX.png");
    ...
    switch (LVL_NUM)
    {
      ...
      *tiles = IMG_LoadTexture(renderer, "images/tiles1.jpg");
      ...
      *wall = IMG_LoadTexture(renderer, "images/wall.jpg");
      *shadow = IMG_LoadTexture(renderer, "images/shadow_wall.jpg");
      *tiles = IMG_LoadTexture(renderer, "images/tiles2.jpg");
      ...
      *wall = IMG_LoadTexture(renderer, "images/wall.jpg");
      *shadow = IMG_LoadTexture(renderer, "images/shadow_wall.jpg");
      *tiles = IMG_LoadTexture(renderer, "images/tiles4.jpg");
      strcpy(LVL_TEXT, "Level: 12");
      break;

      case 5:
      *wall = IMG_LoadTexture(renderer, "images/red_wall.jpg");
      *shadow = IMG_LoadTexture(renderer, "images/red_shadow.jpg");
      *tiles = IMG_LoadTexture(renderer, "images/tiles3.jpg");
      ...
      *wall = IMG_LoadTexture(renderer, "images/wall.jpg");
      *shadow = IMG_LoadTexture(renderer, "images/shadow_wall.jpg");
      *tiles = IMG_LoadTexture(renderer, "images/pond_wall.jpg");
      ...
      *wall = IMG_LoadTexture(renderer, "images/red_wall.jpg");
      *shadow = IMG_LoadTexture(renderer, "images/red_shadow.jpg");
      *tiles = IMG_LoadTexture(renderer, "images/lava_wall.jpg");
      ...
      *wall = IMG_LoadTexture(renderer, "images/wall.jpg");
      *shadow = IMG_LoadTexture(renderer, "images/shadow_wall.jpg");
      *tiles = IMG_LoadTexture(renderer, "images/grass_wall.jpg");
